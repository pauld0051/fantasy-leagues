# https://www.scoreboard.com/game/hz3Xarp1/#game-statistics;0
...
source = requests.get(
    'https://www.scoreboard.com/en/match/hz3Xarp1/#match-statistics;0').text
...
url = 'https://www.scoreboard.com/en/match/hz3Xarp1/#match-statistics;0'
