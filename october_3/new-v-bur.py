# https://www.scoreboard.com/game/25pOM5iE/#game-statistics;0
...
source = requests.get(
    'https://www.scoreboard.com/en/match/25pOM5iE/#match-statistics;0').text
...
url = 'https://www.scoreboard.com/en/match/25pOM5iE/#match-statistics;0'
