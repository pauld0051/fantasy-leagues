# https://www.scoreboard.com/game/KM4P14Fl/#game-statistics;0
...
source = requests.get(
    'https://www.scoreboard.com/en/match/KM4P14Fl/#match-statistics;0').text
...
url = 'https://www.scoreboard.com/en/match/KM4P14Fl/#match-statistics;0'
